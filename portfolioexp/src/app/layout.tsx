...
const dmSans         = DM_Sans({       subsets: ["latin"], variable: "--font-body-dm", display: "swap" });
const plusJakarta    = Plus_Jakarta_Sans({ subsets: ["latin"], variable: "--font-body-pj", display: "swap" });
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = settings?.seoDescription || "Full-stack developer portfolio.";
