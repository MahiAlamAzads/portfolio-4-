...
import { Save, CheckCircle, AlertCircle, Palette, Type, Search, Layout } from "lucide-react";
...
const FONTS   = ["Inter", "Geist", "DM Sans", "Plus Jakarta Sans", "Space Grotesk"];
    ...
    <div className="space-y-6">
      ...
      <div className="card p-6 space-y-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-slate-500 mt-1">Appears in browser tab and search results.</p>
        </div>
      ...
      <div className="card p-6 space-y-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (/^#[0-9a-fA-F]{0,6}$/.test(val)) update("primaryColor", val);
              }}
              maxLength={7}
            ...
            <div className="flex gap-1.5">
              {["#6366f1","#8b5cf6","#ec4899","#14b8a6","#f59e0b","#ef4444"].map((c) => (
                <button
                  key={c}
                  type="button"
                  ...
                  className={`w-6 h-6 rounded-full border-2 transition-transform hover:scale-110 ${
                    form.primaryColor === c ? "border-white scale-110" : "border-transparent"
                  }`}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">
            <span className="flex items-center gap-1.5"><Type size={13} /> Font Family</span>
          </label>
